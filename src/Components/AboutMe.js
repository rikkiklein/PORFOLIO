      ...
      <div className="about-outer-paper">
        <div className="time">
          ...
          <div className="logo-text">
            <h2>General Assembly Web Development Immersive June - September 2016</h2>
        ...
        <div className="time">
          ...
          <div className="logo-text">
            <h2>Brooklyn College Internship January 2015 - January 2016</h2>
        ...
        <div className="time">
          ...
          <div className="logo-text">
            <h2>Brooklyn College City University of New York June <br/>2012 - May 2016</h2>
